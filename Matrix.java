...
public class Matrix {
    ...
    //
    public Matrix identity(String activation, int nthDerivative) throws Exception {
        switch (nthDerivative) {
            case 0:
                return this;
            case 1:
    ...
    public Matrix identity(Matrix a, String activation, int nthDerivative) throws Exception {
        return this.set("*", "*", a).identity(activation, nthDerivative);
    }

    public static Matrix identityClone(Matrix a, String activation, int nthDerivative) throws Exception {
        return Matrix.create(a.rows, a.columns).identity(a, activation, nthDerivative);
    }
    ...
    public Matrix cost(Matrix b, String cost, int nthDerivative) throws Exception {
        switch (cost) {
            ...
            case "meanAbsoluteError":
                return this.meanAbsoluteError(b, nthDerivative);
            default:
                throw new Exception();
        }
    ...
    public Matrix meanAbsoluteError(Matrix b, int nthDerivative) throws Exception {
        switch (nthDerivative) {
            case 0:
                for (int i = 0; i < this.cells.length; i++) {
                    this.cells[i] = Math.abs(this.cells[i] - b.cells[i]);
                }
                return this;
            case 1:
                for (int i = 0; i < this.cells.length; i++) {
                    double diff = this.cells[i] - b.cells[i];
                    if (diff > 0) {
                        this.cells[i] = 1.0;
                    } else if (diff < 0) {
                        this.cells[i] = -1.0;
                    } else {
                        this.cells[i] = 0.0; // Exact match has a derivative of 0
                    }
                }
                return this;
            default:
    ...
    public Matrix meanAbsoluteError(Matrix a, Matrix b, int nthDerivative) throws Exception {
        return this.set("*", "*", a).meanAbsoluteError(b, nthDerivative);
    }

    public static Matrix meanAbsoluteErrorClone(Matrix a, Matrix b, int nthDerivative) throws Exception {
        return Matrix.create(a.rows, a.columns).meanAbsoluteError(a, b, nthDerivative);
    }

    public Matrix meanAbsoluteErrorClone(Matrix b, int nthDerivative) throws Exception {
        return Matrix.meanAbsoluteErrorClone(this, b, nthDerivative);
    }
}